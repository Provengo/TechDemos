 ...
 */
const GOALS = ["add-new", "load-existing", "delete"].map( eventName => mainSm.enterEvent(eventName));
GOALS.push( maybeEvent("rainyDayUpdate").yes );
GOALS.push( maybeEvent("rainyDayUpdate").no  );
GOALS.push( maybeEvent("rainyDayDelete").yes );
GOALS.push( maybeEvent("rainyDayDelete").no  );
