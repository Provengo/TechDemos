...
| Searching terms in https://ecosia.org[Ecosia search engine]. Same process as above, modeled as a BPMN.
| bp-base, `bpmn`, selenium-based direct actuations, script generation, test books
...
| link:morning[]
| Demo of a morning routine. Sample site is available at http://morning.provengo.tech/[provengo-morning-routine].
This example demonstrates using bp together with a library link:/morning/lib/Action.js[(Action.js)]
| `bp-base`, `Ctrl`, `Constraints`, selenium-based actuations, 
