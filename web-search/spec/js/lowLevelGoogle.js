...
const googleDiagram = Bpmn.diagram("HighLevelGoogle");
let seleniumSession;
let searchTerm;

googleDiagram.atStartEvent("start session").run(function(){
...
googleDiagram.atActivity("search").run(function(){
...
googleDiagram.atActivity("validate").run(function(){
