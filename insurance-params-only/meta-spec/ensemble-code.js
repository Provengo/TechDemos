 ...
 * Claims of $1000 and $2001, all topics, and all expected results.
 */
const GOALS = [
    claimAmount.setToEvent("1000"),
    claimAmount.setToEvent("2001")
].concat( 
    claimTopic.getAllSetEvents()
).concat(
    expectedResult.getAllSetEvents()
);
